...
export class Tab2Page {
  ...
  public cards: Card[] = [
    ...
    { 
      ...
      file: "CAPSCOOK.pdf", 
      category: 'stem',
      keywords: ['dishes', 'recipe', 'mobile application'],
    ...
    { 
      ...
      file: "CHAMBURST.pdf", 
      category: 'stem',
      keywords: ['prototype', 'Coronavirus', 'wastes', 'disinfection', 'medical'],
    ...
    { 
      ...
      category: 'stem',
      keywords: ['website', 'effectiveness', 'Jimdo'],
    ...
    { 
      ...
      file: "CapSica.pdf", 
      category: 'stem',
      keywords: ['learning', 'STEM', 'Physics', 'mobile application', 'digital', 'competency'],
    ...
    { 
      ...
      file: "DEXTER.pdf", 
      category: 'stem',
      keywords: ['energy depletion', 'greenhouse emissions', 'generator', 'environmental preservation', 'electricity generation', 'eco-friendly technology', 'prototype'],
    ...
    { 
      ...
      category: 'stem',
      keywords: ['Covid-19', 'Disease', 'education', 'efficiency', 'website'],
    ...
    { 
      ...
      category: 'stem',
      keywords: ['Chemistry', 'periodic table', 'mobile application'],
    ...
    { 
      ...
      file: "FORMULATE.pdf", 
      category: 'stem',
      keywords: ['Mathematical formulas', 'calculation skills', 'mobile application'],
    ...
    { 
      ...
      file: "GRASS-O.pdf", 
      category: 'stem',
      keywords: ['plastic pollution', 'prototype'],
    ...
    { 
      ...
      category: 'stem',
      keywords: ['multi-purpose chair', 'recycle', 'accessibility', 'organizing', 'prototype'],
    ...
    { 
      ...
      category: 'stem',
      keywords: ['face-to-face methods', 'innovative learning tool', 'website'],
    ...
    { 
      ...
      file: "LOT 17.pdf", 
      category: 'stem',
      keywords: ['prototype', 'game-based learning,', 'effectiveness in teaching algebra'],
    ...
    { 
      ...
      category: 'stem',
      keywords: ['Plastic Pollution', 'multipurpose', 'prototype'],
    ...
    { 
      ...
      file: "OSSC.pdf", 
      category: 'stem',
      keywords: ['COVID-19', 'prototype', 'alcohol holder'],
    ...
    { 
      ...
      category: 'stem',
      keywords: ['overall health', 'website', 'improvement and performance monitoring'],
    ...
    { 
      ...
      category: 'stem',
      keywords: ['Chatbots', ' Digital Technology', 'Artificial Intelligence', 'AI', 'COVID 19', 'mobile application'],
    ...
    { 
      ...
      category: 'stem',
      keywords: ['website', 'modern technology', 'school-related problems'],
    ...
    },
    {
      ...
      file: "SYNTHESIS.pdf", 
      category: 'stem',
      keywords: ['prototype', 'learning tool', 'chemistry'],
    ...
    { 
      ...
      category: 'stem',
      keywords: ['Mathematics', 'Trigonometry', 'recreational', 'educational', 'prototype'],
    ...
    { 
      ...
      category: 'stem',
      keywords: ['Heat', 'Thickness', 'Water Absorption', 'prototype'],
    ...
    { 
      imageUrl: "assets/images/proto.png", 
      subtitle: "Unit Tower: A Leisure Block Stacking Game For Mastering Metric System of Measurements", 
      file: "Unit Tower.pdf", 
      category: 'stem',
      keywords: ['Measurements', 'Mathematics', 'prototype'],
    ...
    { 
      ...
      file: "VELOX.pdf", 
      category: 'stem',
      keywords: ['registrar', 'technology', 'scholastic documents', 'acquisition', 'digital', 'office schedule', 'availability', 'mobile application'],
    ...
    { 
      ...
      file: "WEPLANTASK.pdf", 
      category: 'stem',
      keywords: ['weekly work planner', 'Website', 'track the student development'],
    ...
    { 
      ...
      file: "ACI .pdf", 
      category: 'stem',
      keywords: ['COVID-19', 'pandemic', 'design', 'navigation', 'website'],
    ...
    { 
      ...
      category: 'stem',
      keywords: ['Mathematics', 'Covid-19', 'PROTOTYPE'],
    ...
    { 
      ...
      file: "Salt Lamp.pdf", 
      category: 'stem',
      keywords: ['Green energy', 'Sustainable energy', 'Electrode', 'Salt water energy', 'PROTOTYPE'],
    ...
    { 
      ...
      file: "TAS TaNGo.pdf", 
      category: 'stem',
      keywords: ['Novel Coronavirus Disease 2019', 'mobile application', 'voluntary participation'],
    ...
    { 
      ...
      category: 'abm',
      keywords: ['Graphics and layouts', 'graphic design', 'feasibility study'],
    ...
    { 
      ...
      category: 'abm',
      keywords: ['financia', 'advertisement', 'service and merchandising', 'pricing', 'feasibility study'],
    ...
    { 
      ...
      file: "S-Mart.pdf", 
      category: 'abm',
      keywords: ['Marketing Plan', 'Analysis', 'Business Concept', 'Service', 'feasibility study'],
    ...
    },
    {
      ...
      category: 'abm',
      keywords: ['Food Park', 'street foods', 'strategy', 'Marketing plan', 'feasibility study'],
    ...
    category: 'abm',
      keywords: ['livestock feed', 'agricultural supplies', 'MARKET', 'feasibility study', 'Agricultural business', 'Advertising'],
  ...
  public filterCards() {
    ...
    this.filteredCards = this.cards.filter(card => {
      ...
      const lowerCaseSubtitle = card.subtitle.toLowerCase();
      const lowerCaseKeywords = card.keywords.map(keyword => keyword.toLowerCase());
      return lowerCaseSubtitle.includes(lowerCaseQuery) || lowerCaseKeywords.some(keyword => keyword.includes(lowerCaseQuery));
    });
  }
